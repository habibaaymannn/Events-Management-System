...
import static com.example.cdr.eventsmanagementsystem.Constants.RoleConstants.*;
...
public class ServiceBookingController {
    ...
    @Operation(summary = "Create a service booking", description = "Creates a new service booking for an event")
    @PostMapping()
