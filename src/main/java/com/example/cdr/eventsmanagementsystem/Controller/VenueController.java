...
@RestController
@RequestMapping(ControllerConstants.VENUE_BASE_URL)
...
public class VenueController {
    ...
    @PreAuthorize("hasRole('" + RoleConstants.VENUE_PROVIDER_ROLE + "')")
    @PutMapping(ControllerConstants.UPDATE_VENUE_URL)
    ...
    @PreAuthorize("hasRole('" + RoleConstants.VENUE_PROVIDER_ROLE + "')")
    @DeleteMapping(ControllerConstants.DELETE_VENUE_URL)
    ...
    @PreAuthorize("hasRole('" + RoleConstants.VENUE_PROVIDER_ROLE + "')")
    @GetMapping(ControllerConstants.GET_VENUE_BOOKINGS_URL)
    ...
    @PreAuthorize("hasRole('" + RoleConstants.VENUE_PROVIDER_ROLE + "')")
    @PostMapping(ControllerConstants.CANCEL_VENUE_BOOKING_URL)
