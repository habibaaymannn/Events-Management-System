...
public interface BookingServiceInterface {
    ...
    // EventBookingResponse bookEventWithSavedCard(EventBookingRequest request, String paymentMethodId);
    // VenueBookingResponse bookVenueWithSavedCard(VenueBookingRequest request, String paymentMethodId);
    // ServiceBookingResponse bookServiceWithSavedCard(ServiceBookingRequest request, String paymentMethodId);
