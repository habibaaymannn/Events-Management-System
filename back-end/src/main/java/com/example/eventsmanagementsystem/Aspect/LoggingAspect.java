package com.example.eventsmanagementsystem.Aspect;
...
public class LoggingAspect {
    ...
    @Pointcut("within(com.example.eventsmanagementsystem.Controller..*)")
    public void controllerLayer() {}

    @Pointcut("within(com.example.eventsmanagementsystem.Service..*)")
    public void serviceLayer() {}

    @Pointcut("within(com.example.eventsmanagementsystem.Repository..*)")
